...
void Interacting_object::set_property(const std::string &property) {
    properties_.insert(property);
}

void Interacting_object::set_properties(const std::set<std::string>& properties) {
  properties_ = properties;
}

void Interacting_object::remove_property(const std::string &property) {
